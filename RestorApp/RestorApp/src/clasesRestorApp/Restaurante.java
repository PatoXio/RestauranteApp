...
public class Restaurante
{
	 ...
	 * Dependiendo de si la mesa se agrego o no, serï¿½ el booleano que retorne
	 */
	 ...
	 * Retornara un booleano dependiendo si el pedido se logrï¿½ agregar o no.
	 */
	 ...
	 * Recibe el objeto Producto, y dependiendo si el producto se logrï¿½
	 * agregar o no, serï¿½ el retorno (true o false) de este proceso.
	 */
	...
	/*
	 * renovarInventario son aquellos metodos que le permite al restaurante renovar y proveer mï¿½s stock
	 * Ya sea a un producto especï¿½fico, o a todos los productos al mismo tiempo.
	 */
	...
	/*
	 * obteneBoletaDeMesa es una sucesiï¿½n de procesos que buscan tomar los pedidos de una mesa
	 * y ser adjuntados (en un arreglo) para imprimirlos en una boleta a ser recibida ante el pago de la misma.
	 * Para ello (antes de eliminar los pedidos de la mesa) se busca ï¿½sta y se pide obtener la Boleta de la mesa.
	 */
	 ...
	 * a saber cuan viable es el negocio en aspectos econï¿½micos.
