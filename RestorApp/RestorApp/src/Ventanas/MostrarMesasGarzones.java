...
public class MostrarMesasGarzones extends JFrame {
	...
	public  MostrarMesasGarzones (Restaurante restaurante)
	{
		super();
		configurarVentana();
	...
	public void inicializarComponentes(clasesRestorApp.Restaurante Lista ) 
	{
		...
		botonAtras.addActionListener(new ActionListener() 
		{
			...
			{
				new VentanaAcciones(restaurante).setVisible(true);
				dispose();
			}
		});
		...
		titulo = new JLabel("Mostrar Pedidos");
		titulo.setFont(new Font("Tahoma", Font.PLAIN, 14));
		titulo.setBounds(161, 11, 114, 14);
		...
		Lista.mostrarMesasGarzonesVentana(textArea);
