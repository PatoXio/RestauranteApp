...
public class Ventana extends JFrame implements ActionListener
{
	...
	*/
	...
	private void configurarVentana(){
		...
		setBounds(100, 100, 450, 300);						//Mueve y cambia el tama�o de un componente para caber dentro de los parametros del panel(PosXEnPanel,PosYEnPanel,LargoComponente,AnchoComponente)
		...
		contentPane.setLayout(null);						//Establece la forma en que se mostraran los diversos objetos a�adidos
	 ...
	 *  
	 *  setFont(TipoLetra,EstiloFuente,Tama�oLetra): Es la fuente de texto que tendra el componente especifico
	 *  											Debe proveerse tipografia, estilo de fuente y el tama�o de �sta.
	 *  
	...
	public void actionPerformed(ActionEvent e) {
		...
		//Si no coincide, entonces se debe volver a ingresar los datos.
			...
			System.out.println("El usuario o la contrase�a ingresadas no existen");
			textusua.setText("");
			textpass.setText("");
